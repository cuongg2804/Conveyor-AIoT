...
from rewrite.devices.camera_discovery import resolve_device_index, scan_device_dicts

class Camera:
  def __init__(self, cti_path=CTI_PATH,user_set="UserSet1", configure_trigger=False, camera_ip=None):
    print("--- Init Camera ---")
